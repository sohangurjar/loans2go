...
if (isset($_POST['submit'])) {
    $bank_name = mysqli_real_escape_string($con, $_POST['bank']);
    ...
    $query = "INSERT INTO loans (`bank`, `type`, interest) VALUES ('$bank_name', '$loantype', '$interest')";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="#" method="post" class="forms-sample">
                                        ...
                                        <div class="form-group row">
                                            <label for="bank" class="col-sm-3 col-form-label">Bank Name</label>
                                            <div class="col-sm-9">
